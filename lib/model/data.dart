...
class Data {
  ...
  static Future<List<Map<String, dynamic>>?> getListHomePost() async{
    ...
    try{
      List<QueryDocumentSnapshot<Map<String, dynamic>>> docs = await getDoc('listHomePost');
  ...
  static Future<List<QueryDocumentSnapshot<Map<String, dynamic>>>> getDoc(String path) async {
    QuerySnapshot<Map<String, dynamic>> snapshot = await FirebaseFirestore.instance.collection(path).get();
  ...
  static Future<List<Map<String, dynamic>>?> getListFoodHome() async {
    ...
    try {
    List<QueryDocumentSnapshot<Map<String, dynamic>>> docs = await getDoc('listFoodHome');
